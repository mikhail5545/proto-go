...
const (
	ProductService_GetProduct_FullMethodName         = "/product.v0.ProductService/GetProduct"
	ProductService_ListProductsByType_FullMethodName = "/product.v0.ProductService/ListProductsByType"
	ProductService_ListProducts_FullMethodName       = "/product.v0.ProductService/ListProducts"
	ProductService_CreateProduct_FullMethodName      = "/product.v0.ProductService/CreateProduct"
	ProductService_UpdateProduct_FullMethodName      = "/product.v0.ProductService/UpdateProduct"
	ProductService_DeleteProduct_FullMethodName      = "/product.v0.ProductService/DeleteProduct"
)
...
type ProductServiceClient interface {
	...
	ListProductsByType(ctx context.Context, in *ListProductsByTypeRequest, opts ...grpc.CallOption) (*ListProductsByTypeResponse, error)
...
func (c *productServiceClient) ListProductsByType(ctx context.Context, in *ListProductsByTypeRequest, opts ...grpc.CallOption) (*ListProductsByTypeResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ListProductsByTypeResponse)
	err := c.cc.Invoke(ctx, ProductService_ListProductsByType_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ProductServiceServer interface {
	...
	ListProductsByType(context.Context, *ListProductsByTypeRequest) (*ListProductsByTypeResponse, error)
...
func (UnimplementedProductServiceServer) ListProductsByType(context.Context, *ListProductsByTypeRequest) (*ListProductsByTypeResponse, error) {
...
func _ProductService_ListProductsByType_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListProductsByTypeRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ProductServiceServer).ListProductsByType(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ProductService_ListProductsByType_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProductServiceServer).ListProductsByType(ctx, req.(*ListProductsByTypeRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ProductService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _ProductService_ListProductsByType_Handler,
		},
		{
